...
task main()
{
	...
	while (true)
	{
		...
		//motor deadzones & assigning values to motors

		////////////////////////////////////////////

		if((motor1Val < 5) && (motor1Val > -5)){
			motor1Val = 0;
		}
		else{
		...
		////////////////////////////////////////////
		//end motor deadzones & assignment of values
